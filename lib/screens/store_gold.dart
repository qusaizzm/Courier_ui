...
class StoreGold extends StatefulWidget {
  @override
  _StoreGoldState createState() => _StoreGoldState();
}

class _StoreGoldState extends State<StoreGold> {
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          _tab('الكل', Color(0xffe2e3e3), Color(0xffd91f26),
                              true),
                          _tab('خاتم الماس', Color(0xfff3e0c8),
                              Color(0xff0c2444), false),
                          _tab(' اسواره  ', Color(0xfff3e0c8),
                              Color(0xff0c2444), false),
                        ],
                      ),
                      Column(
...
//              _buildRightSection(),
            ...
            _sidebar(),
            _positioned("سوق الدهب", " محوهرات المصري", " محوهرات تبوك    ",
                "   المتجر  "),
          ],
        ),
      ),
